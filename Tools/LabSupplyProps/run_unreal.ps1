...
$taskScript=@{Assets='verify_assets_driver.py';Map='verify_map_driver.py'}[$Mode]
...
$taskReportName=@{Assets='unreal_reload_validation.json';Map='unreal_map_reload_validation.json'}[$Mode]
