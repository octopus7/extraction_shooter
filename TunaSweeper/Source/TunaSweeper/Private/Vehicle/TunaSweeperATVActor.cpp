...
ATunaSweeperATVActor::ATunaSweeperATVActor()
{
	...
	// Retained for existing Blueprint component references; collision comes from the chassis Physics Asset.
	ChassisCollision->SetCollisionEnabled(ECollisionEnabled::NoCollision);
