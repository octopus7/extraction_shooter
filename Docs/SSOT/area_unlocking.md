...
| 항목 | 기준 | 역할 |
|---|---|---|
| 가방 장착 | 획득한 가방 장착 | 기본 40칸에서 장착 가방에 따라 50/60/80/100칸을 사용한다. 별도 영구 확장 퀘스트는 없다. |
...
보스 처치 후 즉시 엔딩으로 가지 않는다. M18 이후 M19/M20을 통해 고급참치와 식탁 준비를 완료하고, 루나와 두더지의 일상 안정화 엔딩으로 닫는다.
