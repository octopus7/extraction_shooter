...
- 영상 길이: 10초
- 구성: 6컷 이미지 기반 이미지-투-비디오
- 대사: 없음
- 자막: 없음
- 화면 텍스트: 없음
- 목적: Tuna Sweeper 엔딩의 "오늘부터 여긴 집" 감정을 조용하게 전달

## 첨부 이미지 순서

아래 이미지를 순서대로 첨부한다.

1. `chatgpt/FirstDinnerEnding/first_dinner_01_bunker_exterior.png`
2. `chatgpt/FirstDinnerEnding/first_dinner_02_tuna_shelf.png`
3. `chatgpt/FirstDinnerEnding/first_dinner_03_table_setup.png`
4. `chatgpt/FirstDinnerEnding/first_dinner_04_premium_tuna_open.png`
5. `chatgpt/FirstDinnerEnding/first_dinner_05_empty_plate_pod02.png`
6. `chatgpt/FirstDinnerEnding/first_dinner_06_final_tableau.png`

## 복사용 프롬프트

```text
Create a 10-second silent cinematic anime ending video using the 6 attached images as ordered visual keyframes.
...
No comedy timing.
No horror tone.
Do not reveal the occupant of POD-02.
Do not add extra characters.
Do not change Luna's outfit, hairstyle, face, or age.
Do not make Luna speak or move her mouth as if speaking.

If audio is generated, use only very subtle ambience: quiet bunker room tone, soft lamp hum, distant night forest ambience, faint tableware sounds, and one soft electronic blink from POD-02. No voices, no singing, no spoken words.

Final feeling: peaceful, warm, slightly bittersweet, complete but with a small unresolved mystery. The bunker has become a home.
```
